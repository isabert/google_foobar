...
journal.txt
start_here.txt
foobar:~/ Silinhaha$ cd queue-to-do/
foobar:~/queue-to-do Silinhaha$ ls readme.txt 
readme.txt
foobar:~/queue-to-do Silinhaha$ cd readme.txt 
cd: readme.txt: Not a directory
foobar:~/queue-to-do Silinhaha$ cat readme.txt 
Queue To Do
===========
